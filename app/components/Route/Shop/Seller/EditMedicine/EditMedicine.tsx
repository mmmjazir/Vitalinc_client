"use client";
import { useEditMedicineMutation, useGetSingleMedicineForInventoryQuery } from "@/redux/features/medicine/medicineApi";
...
const EditMedicine = () => {
  ...
  const [editMedicine, {isSuccess,error:updateError,data:updatedResponse,isLoading:isUpdating}] = useEditMedicineMutation();
  ...
  return (
    ...
    <h1 className="text-2xl font-semibold text-gray-800 mb-6">Edit Medicine</h1>
    {!isLoading && medicine && (
      <>
          ...
          <TabsContent value="contents-uses">
            <Card className="py-3">
              <CardContent className="space-y-6">
                ...
                <MedicineContainsForm medicine={medicine} setMedicine={setMedicine} />
                <MedicineSideEffectsForm medicine={medicine} setMedicine={setMedicine} />
